...
def main():
    ...
    parser.add_argument('rsfdb', nargs='+', help="""Path to a runtime RSF
                        database generated by psyko app. These files are found
                        in the generation directory, under the name
